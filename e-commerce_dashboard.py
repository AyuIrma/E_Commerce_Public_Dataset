...
st.markdown('Ini adalah dashboard interaktif yang menunjukkan analisis dari dataset e-commerce yang berfokus pada pembelian produk dan rating pelanggan.')
